...
```bash
cd JAX
python -m rtip_jax.cli synthesize --inputs examples/ic5c02384/reactions/1-tBu__MeCN/1.xyz examples/ic5c02384/reactions/1-tBu__MeCN/2.xyz --output examples/ic5c02384/reactions/1-tBu__MeCN/IS.xyz --dist 5.0 --seed 0
```
